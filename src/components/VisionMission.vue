        ...
        <div class="w-full px-4 lg:w-6/12">
          <div class="-mx-3 flex items-center sm:-mx-4">
            <div class="w-full px-3 sm:px-4 xl:w-1/2">
              <div class="py-3 sm:py-4 shadow-lg rounded-md" data-aos="fade-right" data-aos-duration="500">
                <img src="/src/assets/images/visionmission/saluran-mampet-1.jpg" alt="" class="w-full rounded-2xl" />
              </div>
              <div class="py-3 sm:py-4 shadow-lg rounded-md" data-aos="fade-right" data-aos-duration="500">
                <img src="/src/assets/images/visionmission/saluran-mampet-2.jpg" alt="" class="w-full rounded-2xl" />
              </div>
            </div>
            <div class="w-full px-3 sm:px-4 xl:w-1/2">
              <div class="relative z-10 my-4" data-aos="fade-left" data-aos-duration="500">
                <img src="/src/assets/images/visionmission/saluran-mampet-3.jpg" alt="" class="w-full rounded-2xl shadow-lg" />
